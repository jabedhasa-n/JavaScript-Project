...
if(yourGender=="Male" || yourGender=="male"){
    boyAge =prompt("Hi Brother,Please type your age");
    girlAge =prompt("Hi Brother,Please type your Fiance's age");
...
else if(yourGender=="Female" || yourGender=="female"){
     girlAge =prompt("Hi Sister,Please type your age");
     boyAge =prompt("Hi Sister,Please type your Fiance's age");
     if (boyAge>=21 && girlAge>=18){
      console.log("Boys age is" + boyAge);
      console.log("girl age is" + girlAge);
